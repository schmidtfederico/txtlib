    ...
    */
    ...
    public:
        ...
        void operator()(string_typeT& text)
            ...
            // std::cout << "First vowel pos: " << m_first_vowel << std::endl;
            ...
            // std::wcout << "Status post 1a: \"" << text << L'"' << std::endl;
            ...
            //step 1b:
            step_1b(text);
            // std::wcout << "Status post 1b: \"" << text << L'"' << std::endl << std::flush;
            //step 1c:
            step_1c(text);
            // std::wcout << "Status post 1c: \"" << text << L'"' << std::endl << std::flush;
            //step 2:
            step_2(text);
            // std::wcout << "Status post 2: \"" << text << L'"' << std::endl << std::flush;
            //step 3:
            step_3(text);
            // std::wcout << "Status post 3: \"" << text << L'"' << std::endl << std::flush;
            //step 4:
            step_4(text);
            // std::wcout << "Status post 4: \"" << text << L'"' << std::endl << std::flush;
            //step 5:
            step_5(text);
            // std::wcout << "Status post 5: \"" << text << L'"' << std::endl << std::flush;
    ...
    private:
        ...
        void step_2(string_typeT& text)
            ...
            if (text.length() >= 7 &&
                ...
                {
                // std::cout << "Matches *ational*. R1: " << stem<string_typeT>::get_r1() << std::endl << std::flush;
                if (stem<string_typeT>::get_r1() <= text.length()-7)
                    {
                    // std::cout << "Call erase" << std::endl << std::flush;
                    text.erase(text.length()-4);
